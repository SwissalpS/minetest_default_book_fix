...
local function book_on_use_fix(itemstack, user)
	...
	minetest.show_formspec(player_name, "default:bookfix", formspec_size .. formspec)
	return itemstack
end -- book_on_use_fix
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	...
	if fields.book_header ~= nil and data.owner == player_name then
		...
		minetest.show_formspec(player_name, "default:bookfix", formspec)
		return
	end
	...
	elseif fields.book_next or fields.book_prev then
		...
		stack:get_meta():from_table({fields = data})
		stack = book_on_use_fix(stack, player)
	end
